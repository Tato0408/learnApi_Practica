...
public class CategoriesController {
    ...
    private ResponseEntity<Map<String, Object>> insertCategory(@Valid @RequestBody CategoryDTO json, HttpServletRequest request){
        try{
    ...
    public ResponseEntity<?> modificarCategoria(
            ...
            @Valid @RequestBody CategoryDTO categoria,
        ...
        try{
            CategoryDTO categoriaActualizada = service.update(id, categoria);
